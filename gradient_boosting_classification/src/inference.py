...
def predict(input_data):
    """
    Loads the best Gradient Boosting model and performs prediction.
    """
    models_dir = "models"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Gradient Boosting Inference for Entertainment Ratings")
