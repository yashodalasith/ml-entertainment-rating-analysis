...
def predict(input_data):
    """
    Loads the best Logistic Regression model and performs prediction on the input data.
    """
    models_dir = "models"
    model_path = os.path.join(models_dir, "best_logistic_model.pkl")
    ...
    print(f"Hit Probability: {probability:.4f}")
    print(f"-------------------------\n")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Logistic Regression Inference for Entertainment Ratings")
