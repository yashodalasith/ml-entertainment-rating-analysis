...
def predict(input_data):
    """
    Loads the best KNN model and performs prediction.
    """
    models_dir = "models"
    model_path = os.path.join(models_dir, "best_knn_model.pkl")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="KNN Inference for Entertainment Ratings")
    ...
    parser.add_argument("--genre", nargs="+", help="List of genres")
