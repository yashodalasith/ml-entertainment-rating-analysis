...
MODELS_DIR = "models"
BEST_MODEL_PATH = os.path.join(MODELS_DIR, "best_knn_model.pkl")
...
def check_model_exists():
    if not (os.path.exists(BEST_MODEL_PATH) and
        ...
        print("Model or preprocessors not found. Please run knn_model.py first.")
        return False
    return True
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Predict if an anime is a 'Hit' using KNN.")
