...
def predict(input_data):
    """
    Loads the best Decision Tree model and performs prediction.
    """
    models_dir = "models"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Decision Tree Inference for Entertainment Ratings")
